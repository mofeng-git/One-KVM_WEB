...
# Lock CPU frequency to avoid ustreamer frame disorder and random black screens
# Adjust frequency based on cpufreq-info if needed
cpufreq-set -d 1200MHz -u 1200MHz

# Start kvmd after locking CPU frequency so services run at a fixed rate

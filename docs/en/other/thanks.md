## Paid Sponsorship Plan

To keep the project sustainable and help cover device and service costs, this project offers a paid
sponsorship plan on a trial basis.
...
1. Sponsorship of 20 RMB or more
...
2. [GitHub - hzyitc/armbian-onecloud: Armbian for OneCloud](https://github.com/hzyitc/armbian-onecloud/)
3. [GitHub - jacobbar/fruity-pikvm: Install PiKVM on Debian SBCs (Orange Pi, Banana Pi, Mango Pi, etc.)](https://github.com/jacobbar/fruity-pikvm)
4. [kvmd-armbian/install.sh at master · srepac/kvmd-armbian](https://github.com/srepac/kvmd-armbian/blob/master/install.sh)
5. [BliKVM - Integrated software and hardware solution for KVM](https://github.com/blikvm/blikvm)
6. [JetKVM - Control any computer remotely](https://github.com/jetkvm/kvm)
